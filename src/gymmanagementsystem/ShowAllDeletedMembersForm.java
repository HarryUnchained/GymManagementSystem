...
public class ShowAllDeletedMembersForm extends javax.swing.JFrame {

    private Admin admin;
    
    public ShowAllDeletedMembersForm(Admin admin) {
        this.admin=admin;
        initComponents();
        showAllMembers();
    }
    ...
    private void showAllMembers(){
        ...
        for(DeletedMember i : new DataBase().getAllDeletedMembers()){
    ...
    private void initComponents() {
        ...
        textUsername.setText("All Deleted Members");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowAllDeletedMembersForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShowAllDeletedMembersForm(new Admin()).setVisible(true);
            }
        });
    }
