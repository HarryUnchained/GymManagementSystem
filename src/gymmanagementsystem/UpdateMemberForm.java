...
public class UpdateMemberForm extends javax.swing.JFrame {
    ...
    public UpdateMemberForm(Admin admin) {
        db = new DataBase();
        this.admin = admin;
        initComponents();
        btnUpdateMember.requestFocus();
        setVisiblity(false);
    }
    ...
    private void updateData(){
        ...
        editTextPassword.setText(member.getPassword());
        editTextAddress.setText(member.getAddress());
        editTextCnic.setText(member.getCnic());
        listGender.setSelectedValue(member.getGender(), true);
        setPackage(member.getPlanNumber());
    }
    ...
    private void setVisiblity(boolean b) {
        editTextName.setVisible(b);
        editTextEmail.setVisible(b);
        editTextAge.setVisible(b);
        editTextCnic.setVisible(b);
        editTextPassword.setVisible(b);;
        editTextAddress.setVisible(b);
        scrollGenderList.setVisible(b);
        panelPlan.setVisible(b);
        panelPlan1.setVisible(b);
        panelPlan2.setVisible(b);
        btnUpdateMember.setVisible(b);
    ...
    private void initComponents() {
        ...
        editTextSearchEmail = new javax.swing.JTextField();
        ...
        btnUpdateMember = new javax.swing.JToggleButton();
        ...
        scrollGenderList = new javax.swing.JScrollPane();
        ...
        editTextSearchEmail.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        editTextSearchEmail.setForeground(new java.awt.Color(51, 51, 51));
        editTextSearchEmail.setText(" Search Email");
        editTextSearchEmail.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        editTextSearchEmail.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                editTextSearchEmailFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                editTextSearchEmailFocusLost(evt);
            }
        });
        editTextSearchEmail.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                editTextSearchEmailActionPerformed(evt);
            }
        });
        editTextSearchEmail.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                editTextSearchEmailKeyPressed(evt);
            }
        });
        jPanel1.add(editTextSearchEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 150, 368, 31));
        ...
        jPanel1.add(btnSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 150, 90, 30));
        ...
        btnUpdateMember.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        btnUpdateMember.setForeground(new java.awt.Color(51, 51, 51));
        btnUpdateMember.setText("Update");
        btnUpdateMember.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        btnUpdateMember.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnUpdateMember.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnUpdateMemberActionPerformed(evt);
            }
        });
        jPanel1.add(btnUpdateMember, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 610, 120, 50));
        ...
        scrollGenderList.setViewportView(listGender);

        jPanel1.add(scrollGenderList, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 530, 370, 30));

        textAddMember.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/EditMemberLogo.png"))); // NOI18N
        ...
        textMessage.setText(" ");
        jPanel1.add(textMessage, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 190, 200, -1));
        ...
        if (name.equals(" Name") || age.equals(" Age") || email.equals(" Email") || password.equals(" Password")
            ...
            try {
                ...
                if (selectedPackage == 0) {
                    ...
                    String startDate=member.getStartingDate(),endDate=member.getEndingDate();
                    
                    if(selectedPackage!=member.getPlanNumber()){
                        startDate=Dates.getCurrentDate();
                        endDate=Dates.getExpiryDate();
                    }
                   
                    Member tempMember = new Member(name, age, email, password, address, cnic,
                    gender, startDate,endDate, "" + selectedPackage);
                    tempMember.setId(member.getId());
                    db.updateMember(tempMember);
    ...
    private void editTextSearchEmailFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_editTextSearchEmailFocusGained
        gainFocus(editTextSearchEmail, " Search Email");
    }//GEN-LAST:event_editTextSearchEmailFocusGained

    private void editTextSearchEmailFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_editTextSearchEmailFocusLost
        lostFocus(editTextSearchEmail, " Search Email");
    }//GEN-LAST:event_editTextSearchEmailFocusLost

    private void editTextSearchEmailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editTextSearchEmailActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_editTextSearchEmailActionPerformed

    private void editTextSearchEmailKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_editTextSearchEmailKeyPressed

    }//GEN-LAST:event_editTextSearchEmailKeyPressed

    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        textMessage.setText(null);
        String email = editTextSearchEmail.getText();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateMemberForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateMemberForm(new Admin("Name", "Email", "Password")).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JToggleButton btnUpdateMember;
    ...
    private javax.swing.JTextField editTextSearchEmail;
    ...
    private javax.swing.JScrollPane scrollGenderList;
